...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def get_new_version(self):
        ...
        try:
            print("Getting new version from {}".format(repo_g3d_printer_config_url))

            result = urllib.request.urlopen(repo_g3d_printer_config_url, timeout = timeout_checking_update)
